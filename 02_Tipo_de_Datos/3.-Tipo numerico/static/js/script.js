...
// Operaciones básicas
let suma = 10 + 5; //Debe mostrar 15
let resta = 10 - 5; //Debe mostrar 5
let multiplicacion = 10 * 5; //Debe mostrar 50
let division = 10 / 2; //Debe mostrar 5
let modulo = 10 % 3; //Debe mostrar 1 --> Resto de la división %
let potencia = 2 ** 3; //Debe mostrar 8
